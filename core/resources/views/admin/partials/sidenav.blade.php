    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.points') }}">
                    <a href="{{ route('admin.points') }}" class="nav-link">
                        <i class="las la-tree menu-icon"></i>
                        <span class="menu-title">Points Commission </span>
                    </a>
                </li>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
                        <ul>
                            @php
                               ...
                               $pageSections = getPageSections(1);
                               ksort($pageSections);
                            @endphp

                            @foreach($pageSections as $k => $secs)
                                @if($secs['builder'])
