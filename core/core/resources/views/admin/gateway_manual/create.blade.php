                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                            ...
                                            <div class="input-group has_append">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">@lang('1') {{ $general->cur_text }} @lang('=')</div>
                                                </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.deposit.manual.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-fw la-backward"></i> @lang('Go
        Back') </a>
@endpush
